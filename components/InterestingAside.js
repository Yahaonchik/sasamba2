...
const InterestingAside = ({
  ...
  items = [
    { text: 'Ошибки, которые приводят к дорого��тоящему ремонту (и как их избежать)', img: '/100x100/image%203823137-200h.webp' },
  ...
  return (
    <aside className={`interesting-aside ${className}`} aria-label={title}>
      ...
      <style jsx>{`
        ...
        .aside-title { color: #000; font-size: 17px; font-family: var(--font-spectral); font-weight: 500; }
