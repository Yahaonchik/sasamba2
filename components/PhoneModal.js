...
@keyframes phoneAnimationModal {
  ...
  75% {
    ...
    filter: brightness(1.1) drop-shadow(0 0 5px rgba(78, 200, 237, 0.5));
        ...
        .pm-schedule { margin-top: 12px; font-family: var(--font-nunito); font-weight: 400; font-size: 14px; color: #000000; } .pm-schedule-bold { font-weight: 700; } .pm-schedule-normal { font-weight: 400; }
        ...
        .pm-phone { display: block; color: #4EC8ED; text-decoration: none; font-family: var(--font-nunito); font-weight: 700; font-size: 26px; line-height: 1.5; letter-spacing: 0; text-shadow: none; }
        ...
        @media (prefers-reduced-motion: reduce) { .pm-wave { animation: none; opacity: .35; } }
                @media (max-width: 560px) { .pm-card { width: 300px; min-width: 280px; height: 283px; border-radius: 14px; background: transparent url('https://cdn.builder.io/api/v1/image/assets%2Fa967e918a30549b3acea58ed36a6d5a2%2F221a9c57e5e349f6bbbcbfd6822b4b27?format=webp&width=800') top center/contain no-repeat; } .pm-center { inset: 29px 0 100px 0; left: 0; right: 0; transform: none; text-align: center; gap: 5px; } .pm-title { font-size: 20px; font-weight: 500; } .pm-phone { font-size: 23px; font-weight: 700; white-space: nowrap; } .pm-schedule { font-size: 14px; } .pm-item.viber, .pm-item.telegram, .pm-item.whatsapp { bottom: 0; } .pm-item.viber { left: 21%; } .pm-item.telegram { left: 50%; } .pm-item.whatsapp { left: 79%; margin-left: -1px; } .pm-icon-link { width: 42px; height: 42px; bottom: 29px; } .pm-caption { font-size: 11px; bottom: 6px; text-align: center; } .pm-waves.left { left: 6px; } .pm-waves.right { right: 6px; } .pm-arcs { top: 35px; height: 92px; } .pm-arcs .wave-left, .pm-arcs .wave-right { width: 40px; height: 92px; } .pm-arcs .wave-left { left: 14px; } .pm-arcs .wave-right { right: 14px; } .variant1 .wave-left .wave-arc { animation: arc1-left-m 1.8s infinite ease-out; } .variant1 .wave-right .wave-arc { animation: arc1-right-m 1.8s infinite ease-out; } .pm-arcs .wave-left .wave-arc:nth-child(4), .pm-arcs .wave-right .wave-arc:nth-child(4) { display: none; } }
