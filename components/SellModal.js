  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .sell-button { color: rgb(255, 255, 255); font-size: 16px; font-style: normal; font-family: var(--font-spectral); font-weight: 500; border: none; border-radius: 8px; letter-spacing: 1px; background-color: rgb(40, 40, 40); cursor: pointer; transition: all 0.3s ease; position: relative; overflow: hidden; width: 100%; height: 60px; max-width: 350px; min-width: 180px; box-shadow: 5px 5px 10px 0px rgba(43, 43, 43, 0.68); }
