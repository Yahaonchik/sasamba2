          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Неисправ��н сливной насос (помпа)' },
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Если датчик неправильно определяет уровень воды, блок управления не срабатывает нормально. При этом машинка может «зависать» перед отжимом – она не сливает воду полностью и аварийно остана��ливается. Признаки: после завершения стирки в бак�� ост��ётся вода, могут появляться ошибки уровня воды. Решается замена прессостата.
                </p>
              </div>
            </section>
