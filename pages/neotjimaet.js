        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                { icon: '/external/vector8669-r6fr.svg', href: '#1', text: 'Что делать, если машин�� не отжимает' },
                { icon: '/vector.svg', href: '#2', text: 'Основные причины поломки:' },
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Неиспра����н сливной насос (помпа)' },
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  <p>
                    ...
                    Он удерживает мелкие предметы — монеты, пуговицы, ворсинки, — и со временем забивается. Ко��да фильтр перекрыт, вода не пр��ходит в насос, и программа отжима не запускается. Обычно фильтр находится внизу на передней панели: откройте лючок, выкрутите пробку и удалите скопившийся мусор. После очистки попробуйте снова включить стирку.
                  </p>

                  <p>
                    <strong>2. Если фильтр в порядке, обратите внимание на сли��ной шланг.</strong><br />
                    Он не должен быть перегнут или зажат мебелью. Изгибы мешают свободному стоку воды, и машина также отказывается переходить к отжиму. Осмотрите шланг по всей длине, расправьте петли и проверьте соединение с канализацией или сифоном. Пр�� необходимости очистите засор в сифоне или замените шланг.
                  </p>
                  ...
                  <p>
                    ...
                    Если вещи сбились в комок, барабан не может сбалансироваться. Встроенный датчик дисбаланса блокирует разгон, чтобы машина не «скакала» по комнате. Перетряхните бельё в барабане, добавьте несколько мелких вещей или, наоборот, разделите большую партию на две стирки. Так ��ельё распреде��ится равномерно, и о��жим пройдёт без проблем.
                  </p>
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если помпа сгорела или в ней сломана крыльчатка, машина не сможет слить воду и переход к отжиму невозможен. Признаки: вода остаётся в баке, машинка гудит во время слива или совсем молчит, и часто появляется ошибка слива на дисплее. Самостоятельный ремонт насоса обычно невозможен.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Если датчик неправильно определяет уровень воды, блок управления не срабат��вает нормально. При этом машинка может «зависать» перед отжимом – она не сливает воду полностью и аварийно остана��ливается. Признаки: после завершения стирки в бак�� ост��ётся вода, могут появляться ошибки уровня воды. Решается замена прессостата.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                <figure className="page-container24">
                  ...
                  />
                  <span className="page-text45">Щетки двига��еля</span>
                </figure>
                <p className="vicetext">
                  {' '}
            ...
            <section id="5-1" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="vicetext">
                  {' '}
                  Полный отказ мотора (обрыв обмоток или короткое замыкани��) – серьезная проблема. Признак – при отжиме машина «зависает», двигатель гудит или совсем тих, а барабан не крутится. Могут выбиваться пробки электрической цепи. Ремонт двигателя – трудоёмкая операция, обычно его заменяют.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="vicetext">
                  {' '}
                  Если датчик оборотов выдаёт неверные показания, контроллер перестаёт доверять двигателю – стиральная машина может просто не давать команду на отжим. Это происходит без явных механических шумов, но при этом барабан ��ибо вращае��ся очень медленно, либо вообще не двигается. Решается з����еной датчика.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему ст��ралка воняет — 7 быст��ых причин и что сделать прямо
                  сейчас
                </span>
              ...
              <div className="page-frame12986">
                <span className="page-text78">
                  М��фы о стир��лк��х: что правда, а что — вымысел?
                </span>
