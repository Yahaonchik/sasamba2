          ...
          <div className="page-left-main-box">
            ...
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              ...
              <div className="page-container17">
                <p className="vicetext">
                  {' '}
                  Наиболее серьёзная причина – это наруше��ие целостности самого бака (емкости) машины. Внутри может образоваться дырка из-за мелких острых предметов – чаще всего стальных косточек от бюстгальтера, проскочивших в барабан. Такие пробоины вызывают неконтролируемый «фонтан»: вода течёт непрерывно и из-под машины в любых режимах. Иногда бак трескается по шву или по износу деформируется, что тоже даёт течь.Совет: к сожалению, отремонтировать корпус бака почти невозможно – его обычно заменяют целиком или вместе с барабаном. Чтобы не допустить такого сбоя, тщательно проверяйте и чистите внутренние карманы у белья. Раз в месяц запускайте режим самоочистки с пустым барабаном (если есть) или используйте специальны�� средства против накипи и загрязнений. Это ум��ньшит нако��ление частиц внутри бака и продлит его ресурс.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В некоторых случаях вода под машиной появляется только во время отжима – это характерно для износа подшипников и сальника барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего вода ��опадает внутрь подшипников и выходит наружу. Сначала заметно лишь учащённое включение помпы аквастопа (если он е��ть), а потом – ржавая или с маслянистыми пятнами вода снизу. При этом машина громко гремит и «гуляет» на отжиме.Совет: осмотреть это свои��и силами можно только сняв заднюю панель, но замена ��одшипников – задача мастера: приходится разбирать весь ба��. Если вы слышите новые скрежет и вибрацию в сочетании с лужей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очистителей и держание машины в ровном положении может чуть замедлить износ, но окончательно устранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и это ��егко заметить по лужице под ней при заливе. К аварийным патрубкам относятся труба от лотка дозатора к баку и любые трубочки между ба��ом, насосом и фильтром. Со временем соединения этих патрубков ослабевают от постоянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками порошка. Засорённая или неплотно подсоединённая труба начинает пропускать воду на стыках, которая капает в поддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">2. Регулярно очищайте дозатор и фильтр.</span> Снимайт�� и промывайте лоток для порошка, промывайте мелкий сливной фильтр на передней панели.
                  <br />
            ...
            <PageNavigation
              prevPage={{
                href: '/negreetvodu',
                title: 'Стираль��ая ма��ина не греет воду'
              }}
              nextPage={{
                href: '/silnoshumit',
