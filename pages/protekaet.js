            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">2. Регулярно очищайте дозатор и фильтр.</span> Снимайте и промывайте лоток дл�� порошка, промывайте мелкий сливной фильтр на передней панели.
                  <br />
                  ...
                  <br />
                  <span className="tip-title">5. Обеспечьте прочную установку машины.</span> Стиральная машина должна стоять строго по уровню: если она «гуляет», вибрации ускоряют износ деталей. Регулируйте ножки так, чтобы машина была неподв��жна при работе.
                  <br />
