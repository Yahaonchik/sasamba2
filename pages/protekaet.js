          ...
          <div className="page-left-main-box">
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В некоторых случаях вода под машиной появляется только во время отжима – это характерно для износа подшипников и сальника барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего вода попадает внутрь подшипников и выходит наружу. Сначала заметно лишь учащённое включение помпы аквастопа (если он есть), а потом – ржавая или с маслянистыми пятнами вода снизу. При этом машина громко гремит и «гуляет» на отжиме.Совет: осмотреть это своими силами можно только сняв заднюю панель, но замена под��ипников – задача мастера: приходится разбирать весь бак. Если вы слышите новые скрежет и вибрацию в сочетании с л��жей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очистителей и держание машины в ровном положении может чуть замедлить износ, но окончательно устранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и это легко заметить по лужице под ней при заливе. К аварийным патрубкам относятся труба от лотка дозатора к баку и любые трубочки между баком, насосом и фильтром. Со временем соединения этих патрубков ослабевают от постоянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками порошка. За��орённая или неплотно подсоединённая труба начинает пропускать воду на стыках, которая капает в поддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <PageNavigation
              prevPage={{
                href: '/negreetvodu',
                title: 'Стиральная машин�� не греет воду'
              }}
              nextPage={{
                href: '/silnoshumit',
