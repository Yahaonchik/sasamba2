          ...
          <div className="page-left-main-box">
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  При первой установке новой стиральной машины многие удивля��тся сильной вибрации и шуму во время работы. Чаще всего это связано с тем, что остаются установочные транспортировочные болты, фиксирующие барабан для безопасной перевозки. Если их не снять до запуска, барабан не сможет свободно вращаться, что вызывает громкий грохот, подпрыгивание машины и риск повреждения деталей. Чтобы техника работала корректно и служила долго, обязательно выкрутите все транспортировочные болты и установите защитные заглушки.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Стиральная машина очень требовательна к прочнос���� и горизонтальности места установки. Если пол под ней не идеально ровный или слишком мягкий (например, старые деревянные доски), люба��� вибрация приведёт к дополнительному «прыжку» техники. Аналогично, установка на очень гладком покрытии (плитке или линолеуме) без фиксации позволит машинке подскальз��вать.Совет: Проверьте положение машины уровнем – все ножки должны стоять устойчиво. Слегка раскачайте прибор руками, определите, какая опора «гуляет» больше, и подкрутите её гайкой против часовой стрелки до упора. Можно привлечь помощника или приподнять стиралку на бок, чтобы повернуть ножку удобнее. После этого ещё раз проконтролируйте ровность с уровнем. Для дополнительной устойчивости и защиты пола рекомендуется уста��овить резиновые антискользящие накладки или антивибрационные подставки под ножки. Они га��ить часть вибрации и не позволяют машине «ездить» по комна��е.
                </p>
              </div>
            </section>
            <div className="page-container15">
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Пружины подвески играют ключевую роль в работе с��иральной машины — они удерживают бак в подвешенном состоянии и компенсируют вибрации при отжиме. Когда хотя бы о��на пружина растянулас�� или сломалаль, бак теряет устойчивость и начинает сильно раскачиваться. Из-за этого вы слышите громкий стук, глухие удары или даже металлический звон. Особенно ярко проблема проявляется на высоких оборотах, когда бак с бельём вращается с максимальной скоростью.
            ...
            <section id="5-1" className="page-fiveproblem2-duplicate1">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  Противовесы — это массивные блоки внутри стиральной машины, которые крепятся к баку и помогают гасить вибрации при стирке и особенно при отжиме. Их задача — стабилизировать бак, чтобы он не раскачивался и не ударялся о корпус. Если один из противовесов ослаб, раскололся или открутился, баланс наруша��тся, и м��шина начинает сильно шуметь, греметь и «прыгать» по полу.Со временем крепёжные болты противовесов ��огут раскрутиться из-за п��стоянной вибрации. В некоторы��� случаях бетонный противовес трескается или крошится — это встречается на старых машинах или после сильных перегрузок бельём. Когда противо��ес не держится плотно, при высоких оборотах бак смещается и начинается сильно стучать по корпусу.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2-duplicate2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  В барабан встроен подшипниковый узел – обычно два шарикоподшипника, закрытые резиновым уплотнителем (сальником). При длительн��й эксплуатации са��ьник протирается, в��утрь попадает вода, смазка вымывается и подшипники ржавеют. Это вызывает л��фт барабана и нерав��омерное вращение. В итоге при отжи��е машин�� может сильно шуметь и «прыгать», а иногда барабан клинит. Признаки износа подшипников – топот под машиной, подтеки ржавой воды и р��зболтанность бака при ручном движении. Починка требует замены подшипников (и сальника) – в большинстве моделей это комплексная работа, выполняемая в сервисе.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12982">
                <span className="page-text74">
                  Как продлить ��изнь маш��н�� ��а 3–5 лет — простые привычки,
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как без��пас��о перевози��ь и хран��ть стиральную машину
                </span>
