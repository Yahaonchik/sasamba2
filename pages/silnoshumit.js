...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Профессиональный ремонт стиральных машин которые шумят и вибрируют в Одессе. Замена под��ипников, амортизаторов.',
    `${baseUrl}/silnoshumit`
  )
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как б��з��пасно перевози��ь и хранить стиральную машину
                </span>
