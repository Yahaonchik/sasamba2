          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Закрыт кран подачи воды / Низкое да��ление' },
              ...
              <div className="page-container13">
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Убедитесь, что люк закрывается плотно и фиксируется. Если бельё мешает закрытию, правильно у��ожите вещи. Машина не начнёт залив, пока замок не сработает.
                  </p>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Устройство блокировки люка (УБЛ) фиксирует дверцу перед стартом. Если оно изношено или сломано, дверца не закрывается плотно и стирка не начнётся. Симптом: машинка не запускается вообще, люк может остаться незаблокированным, част�� загорается ошибка. Проверьте, плотно ли закрывается люк – он должен щёлкать. Если замок не срабатывает, машина «гудит», но воды не набирается. Осмотрите уплотнитель и корпус замка: при деформации или поломке нужен мастер.
                </p>
              </div>
            </section>
