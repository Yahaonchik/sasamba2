          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2', text: '1. Закрыт кран подачи воды / Низкое ��авление' },
              ...
              <div className="page-container13">
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Убедитесь, что люк з���крывается плотно и фиксируется. Ес��и бельё мешает закрыт��ю, правильно уложите вещи. Машина не начнёт з��лив, пока замок не сработает.
                  </p>
