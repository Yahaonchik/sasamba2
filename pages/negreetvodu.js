          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2-1', text: '2. Сломан датчик температуры (термо��тат)' },
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасно перевозить и хранить стир��льную машину
                </span>
