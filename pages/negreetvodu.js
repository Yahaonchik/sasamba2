          ...
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                ...
                { icon: '/external/vector8669-r6fr.svg', href: '#2-1', text: '2. Сломан датч��к температуры (терм��стат)' },
            ...
            <div className="page-container15">
              <h2 className="page-text34">
                <span>Основ��ые причины поломки:</span>
                <br></br>
              </h2>
            </div>
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасно п��ре��озит�� и хранить стиральную машину
                </span>
