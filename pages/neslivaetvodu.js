            ...
            <section id="2" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  2. Неисправность датчика уров��я воды (прессостата)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                <div className="vicetext">
                  ...
                  <p><strong>3. Следите за полож��нием сливного шланга.</strong><br />Шланг не должен перегибаться или пережиматься. Оптимальная высота вывода — до 50 см от уровня пола. Ставьте машинку ровно и снижайте вибрации, чтобы не перетирались провода и не ослабевали патрубки.</p>
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12982">
                <span className="page-text74">
                  Как продлить жизн�� машине на 3–5 лет — простые ��ривычки,
