          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container17">
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Откройте дверцу и выньте часть белья. При необходимости уменьшите загрузку, если она была слишком большой. Ес��и белья совсем мало, добав��те ещё 2–3 вещи р��вн��го веса. В��тряхните оставшиеся вещи, равномерно распределив их по барабану.
                  </p>
                  ...
                  <p>
                    ...
                    дверца остаётся разблокированной – машина ��е начнёт цикл
                    стирки.
                  </p>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  В коллекторных двигателях со вре��енем изнашиваются угольные щётки, и при плохом конта��те ��отор теряет мощность или вообще не запускается; иногд�� слышен только ��ул мотора без движения барабана, а при серьёзном поврежд��нии обмоток возможен и полный отказ. При подозрении на износ щёток или внутренние проблемы мотора самостоятельный ремонт не рекомендуется — точную диагностику и замену выполняет мастер, который проверит состояние щёток, обмоток и подшипников и при необходимости выполнит квалифицированную замену.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              <div className="page-container25 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  4. С��ои в электронном блоке управления
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12981">
                <span className="page-text73">
                  О��ибки, которые приводят к дорогостоящему р��монту (и как их
                  и��бежать)
                </span>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасн�� перевозить и хранить стиральную машину
                </span>
