          ...
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Этот приём подойдёт для прочных тканей (лучше избегать шёлка и шерсти). Разведите очень горячую воду и погрузите поражённый участок на 5–10 минут – жвачка быстро расплавится. Аккуратно счистите размягчённые кусочки щёткой. Также можно воспользоваться утюгом: положите под шмотку плотный картон (и��и бумажное полотенце), прогрейте утюг до 100–120 °C и на несколько секунд прижмите им место с жвачкой. Жвачка расплавится и прилипне�� к картону. Повторяйте, пока все остатки не исчезнут. После используйте ткань: поместит�� тряпочку между утюгом и вещью, чтобы не пропекать волокна.
                </p>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Если ни холод, ни тепло не помогли, пробуйте местные растворители. Жидкость для снятия лака с ацетоном мягко разъедает жевательную резинку – смочите ватный диск, приложите к пятну на 2–3 минуты, затем сотрите резинку щёткой. Ксилол (уайт-спирит) или промышленный очиститель WD-40 тоже эффективно размягчают клейкость жвачки. Эти средства хорошо подходят для плотных тканей, но обязательно протестируйте их на незаметном фрагменте, чтобы избежать обесцвечивания. По��ле применения растворителя одежду нужно о��язательно выстирать – это удалит остатки хими�� и запах.
                </p>
              </div>
            </section>
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12986">
                <span className="page-text78">
                  Мифы о стиралках: что правда, а что — вымыс��л?
                </span>
