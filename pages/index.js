            ...
            <div className="frame1196-container125">
              <div className="frame1196-container126">
                ...
                <p className="frame1196-text134">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Бесплатный выезд специалиста в люб��й район города',
                    }}
                  ></span>
                </p>
              </div>
            ...
            <div className="frame1196-blue3">
              <div className="frame1196-container141">
                ...
                <span className="frame1196-text152">
                  Диагностока оборудования (при отказе от р��монта)
                </span>
              </div>
        ...
        to {
          ...
          <div className="frame1196-container151 carousel">
            <div className="frame1196-container152 track">
              ...
              <div className="item">
                <img
                  alt="Ремонт стиральных машин Samsung в Од��ссе - профессиональьный сервис"
...
to {transform: translateX(-2620px);}}
          ...
          <div className="frame1196-container209">
            ...
            <div className={`frame1196-otvet1 ${activeFAQ === 1 ? 'faq-active' : ''}`}>
              <p className="frame1196-text240">
                <span
                  dangerouslySetInnerHTML={{
                    __html: '99% поломок устраняем на месте за 30-60 минут. Только редкие случаи требуют заказа специфических де��алей и повторного визита через 1-2 дня',
                  }}
                ></span>
              </p>
            </div>
        ...
        <div className="frame1196-container225">
          ...
          <h2 className="textglavitogi">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Частые по��омки стиралнных машин',
              }}
            ></span>
          </h2>
          ...
          <ul className="frame1196-ul2 list">
            ...
            <li className="list-item">
              <span className="textITOGI">
                <span
                  dangerouslySetInnerHTML={{
                    __html: 'Не греет воду — диагнос��ика и замена ТЭНа.',
                  }}
                ></span>
              </span>
            </li>
          ...
          <p className="textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Ниже на сайте — карта проезда к нашей мастерской, а также наши телефоны. Звоните для записи, консультации или если заметили сбои в работе вашей стиральной машины. Мы всё объясним, рассчитаем стоимость и поможем."Ваше название" — это ремонт стиральных машин в Одессе быстро, надёжно и профес��ионально.',
              }}
            ></span>
          </p>
        </div>
      ...
      <style jsx>
        {`
          ...
          /* Дополнительные hover эффекты для текста и ��конок в ��нопках */
