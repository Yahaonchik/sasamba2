    ...
    <>
      <main className="frame1196-container100">
          ...
          <article className="frame1196-cards">
            <Link legacyBehavior href="/neslivaetvodu">
              <a className="frame1196-container113">
                ...
                <div className="frame1196-image15"><Image alt="Стиральная ��ашина не сливает воду" src="/problems 2/11-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/negreetvodu">
              <a className="frame1196-container114">
                ...
                <div className="frame1196-image16"><Image alt="Ст��ральная машина не нагревает воду" src="/problems 2/21-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/protekaet">
              <a className="frame1196-container115">
                ...
                <div className="frame1196-image17"><Image alt="Ст���ральная машина протекает" src="/problems 2/31-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/silnoshumit">
              <a className="frame1196-container116">
                ...
                <div className="frame1196-image18"><Image alt="����тиральн��я машина шумит при отжиме" src="/problems/4-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/nevkluchaetsa">
              <a className="frame1196-container117">
                ...
                <div className="frame1196-image19"><Image alt="Стирал����ная машина не вклю��ается" src="/problems 2/51-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/zavisaetnaprogramme">
              <a className="frame1196-container118">
                ...
                <div className="frame1196-image20"><Image alt="Стиральная машина зависает на программе" src="/problems 2/61-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/neotjimaet">
              <a className="frame1196-container119">
                ...
                <div className="frame1196-image21"><Image alt="Стиральная машина не отжимает" src="/problems 2/71-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/nenabiraetvodu">
              <a className="frame1196-container120">
                ...
                <div className="frame1196-image22"><Image alt="Стиральная машина не наби��ает воду" src="/problems/8-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
              </a>
            </Link>
            <Link legacyBehavior href="/neotkrivaetsadverca">
              <a className="frame1196-container121">
                ...
                <div className="frame1196-image23"><Image alt="Не откры��ается дверца стиральной машины" src="/problems 2/91-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover', objectPosition: 'top left' }} /></div>
              </a>
            </Link>
            <a href="/nekrutitbaraban" className="frame1196-container122">
              ...
              <div className="frame1196-image24"><Image alt="Сти��альная ма��ина не крутит барабан" src="/problems/10-300h.webp" fill sizes="149px" quality={100} priority={isMobile} loading={isMobile ? 'eager' : 'lazy'} style={{ objectFit: 'cover' }} /></div>
            </a>
          </article>
        </section>
                ...
                <div className="frame1196-container173">
                  <div className="frame1196-container174">
                    <h3 className="frame1196-text222">
                      <span
                        dangerouslySetInnerHTML={{
                          __html: 'Низ��ие ��ены на весь сервисный диапаз��н услуг',
                        }}
                      ></span>
                    </h3>
                    <svg
          ...
          <div className="frame1196-container221">
            ...
            <div className={`frame1196-otvet5 ${activeFAQ === 5 ? 'faq-active' : ''}`}>
                <p className="frame1196-text248">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: 'Если ��то��мость ремонта превышает 60% от цены новой машшины - луучше заменить. Мы всегда честно консультируем от целесообра��ност�� ремонта.',
                    }}
                  ></span>
                </p>
            </div>
        ...
        <div className="frame1196-container225">
          ...
          <p className="textITOGI">
            <span>Ниже на сайте — карта проезда к нашей маст��рской, а также наши телефоны. Звоните для записи, ко��сультации или если заметили сбои в работе вашей стиральной машины. Мы всё объясним, рассчитаем стоимость и поможем. "Ваше название" — это ремонт стиральны�� машин в Одессе быстро, надёжно и профес��ионально.</span>
          </p>
        </div>
      ...
      <style jsx>
        {`
          ...
          .frame1196-hero-bg-img { object-fit: cover !important; object-position: bottom center !important; width: 100% !important; height: 100% !important; min-width: 0 !important; min-height: 0 !important; max-width: none !important; max-height: none !important; }
