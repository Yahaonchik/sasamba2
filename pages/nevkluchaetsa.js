          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Откройте кран подачи воды д��я стиральной машины и осмотрите заливной шланг: нет ли перегиба или засора на входе. Сломанный или перекрученный шланг и закрытый кран тоже остановят работу.
                  </p>
            ...
            <section id="4" className="page-fiveproblem1">
              <div className="page-container22 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Вышел из строя центральный модуль у��равления
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Мозг стиральной машины — это управляющая ��лата. Именно она хранит программы стирки и управляет всеми процессами. Если она выходит из строя, техника не запускается, индикат��ры не горят или ведут себя странно. Иногда помогает простой сброс: отключите питание на 10–20 минут и попробуйте снова. Если не помогло — скорее всего, нужна прошивка, ремонт или замена модуля. Этим обычно занимается специалист.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299" style={{display:"none"}}>
              ...
              <div className="page-frame12986">
                <span className="page-text78">
                  Мифы о стиралках: что правда, а что — вы��ысел?
                </span>
