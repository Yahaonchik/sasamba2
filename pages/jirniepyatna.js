        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <AnchorLinksSection
              ...
              items={[
                { icon: '/vector.svg', href: '#2', text: 'Как избавиться от жирных пятен на оде��де:' },
            ...
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Жидкость для мытья посуды содержит компоненты, разрушающие жировые загрязнения, поэтому она подходит и для одежды. Нанесите нес��олько капель средства на ��ятно и оставьте на 5–10 минут. Затем постирайте вещь – как правило, этого достаточно. Для очень застарелых пятен можно предварительно замочить одежду: нанесите гель на пятно, накройте пищевой плёнкой на пару часов, а потом постирайте в тёплой воде с порошком. Это сочетание агрессивного средства и дополнительного времени улучшит результат.
                </p>
              </div>
            </section>
